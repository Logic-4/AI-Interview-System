  ...
  return (
    <div className="max-w-4xl mx-auto py-6 space-y-6 animate-in fade-in duration-500">
      <div className="space-y-1">
        <h1 className="text-2xl font-semibold tracking-tight text-text-primary">Study Plan</h1>
        <p className="text-sm text-text-muted font-medium">Personalized recommendations based on your interview performance</p>
      </div>

      {/* Overview */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card hoverEffect={false} className="p-5 border-border/40 bg-surface/30 text-center">
        ...
        <Card hoverEffect={false} className="p-5 border-border/40 bg-surface/30 flex flex-col items-center justify-center">
          <BarChart3 className="w-6 h-6 text-primary mb-2" />
          <p className="text-lg font-bold text-text-primary">{progress?.totalInterviewsReviewed ?? 0}</p>
          <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Interviews Reviewed</p>
        </Card>
        <Card hoverEffect={false} className="p-5 border-border/40 bg-surface/30 flex flex-col items-center justify-center">
          <Target className="w-6 h-6 text-primary mb-2" />
          <p className="text-lg font-bold text-text-primary">{plan?.weeklyGoal ?? 3}/week</p>
          ...
          <div className="space-y-4">
            {plan.areas.map((area, i) => (
              <motion.div
                ...
                className="p-4 rounded-xl border border-border/40 bg-foreground/[0.02] space-y-3"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-text-primary">{area.name}</p>
                      <Badge className={cn(
                ...
                <p className="text-[11px] text-text-muted font-medium leading-relaxed flex items-start gap-2">
      ...
      <Card hoverEffect={false} className="p-6 border-border/40 bg-surface/30">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/interviews/new" className="block">
            <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 hover:bg-primary/10 transition-colors group">
              <div className="flex items-center gap-3">
                <Play className="w-5 h-5 text-primary" />
                <div className="flex-1">
                  <p className="text-xs font-semibold text-text-primary">Start a Practice Interview</p>
                  <p className="text-[10px] text-text-muted font-medium mt-0.5">Focus on your weakest areas</p>
                </div>
          ...
          <Link href="/questions" className="block">
            <div className="p-4 rounded-xl border border-border/40 bg-foreground/[0.02] hover:bg-foreground/[0.04] transition-colors group">
              <div className="flex items-center gap-3">
                <BookOpen className="w-5 h-5 text-primary" />
                <div className="flex-1">
                  <p className="text-xs font-semibold text-text-primary">Browse Practice Questions</p>
                  <p className="text-[10px] text-text-muted font-medium mt-0.5">Study sample answers and tips</p>
                </div>
                <ArrowRight className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </div>
          ...
          <Link href="/analytics" className="block">
            <div className="p-4 rounded-xl border border-border/40 bg-foreground/[0.02] hover:bg-foreground/[0.04] transition-colors group">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs font-semibold text-text-primary">View Progress Analytics</p>
                  <p className="text-[10px] text-text-muted font-medium mt-0.5">Track your improvement over time</p>
                </div>
                <ArrowRight className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </div>
          ...
          <Link href="/interviews" className="block">
            <div className="p-4 rounded-xl border border-border/40 bg-foreground/[0.02] hover:bg-foreground/[0.04] transition-colors group">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs font-semibold text-text-primary">Review Past Interviews</p>
                  <p className="text-[10px] text-text-muted font-medium mt-0.5">Learn from your previous attempts</p>
                </div>
                <ArrowRight className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </div>
      ...
      {!progress && (
        <Card hoverEffect={false} className="p-8 border-border/40 bg-surface/30 text-center">
          ...
          <p className="text-xs text-text-muted font-medium mb-4">Complete a few interviews to generate your personalized study plan.</p>
          <Link href="/interviews/new">
            <Button className="h-10 px-6 rounded-lg text-xs font-bold">
