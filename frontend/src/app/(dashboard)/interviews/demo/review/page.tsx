    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
         ...
         <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="h-10 px-5 bg-primary hover:bg-primary-light text-white text-xs font-bold gap-2 rounded-xl shadow-[0_0_15px_rgba(41,98,255,0.3)]"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         ...
         <Card className="p-6 border-white/5 bg-surface/40 hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="flex items-baseline gap-2 mb-4">
               <span className="text-3xl font-black tabular-nums">{(overallScore / 10).toFixed(1)}</span>
               <span className="text-sm font-bold text-text-muted">/ 10</span>
            </div>
            <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
               <div className="h-full bg-primary shadow-[0_0_10px_rgba(41,98,255,0.5)]" style={{ width: `${overallScore}%` }} />
            </div>
         </Card>
         ...
         <Card className="p-6 border-white/5 bg-surface/40 hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="mb-2">
               <span className="text-2xl font-black">{getConfidenceLabel(confidenceScore)}</span>
            </div>
         ...
         <Card className="p-6 border-white/5 bg-surface/40 hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="flex items-baseline gap-2 mb-2">
               <span className="text-2xl font-black tabular-nums">{criticalGaps}</span>
      ...
      <div>
              ...
              <Card
                ...
                className={cn(
                  ...
                  isExpanded
                    ...
                    : "border-white/5 bg-surface/20 hover:bg-surface/40 hover:border-white/10 cursor-pointer"
                )}
              >
                <div
                ...
                >
                  ...
                  <h3 className="text-sm font-bold flex-1">{q.text}</h3>
         ...
         {!(interview?.questions?.length) && (
            <Card className="p-8 border-white/5 bg-surface/30 text-center text-sm font-medium text-text-muted">
