...
import { Bot, ChevronDown, LogIn } from "lucide-react";
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-8">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="bg-gradient-primary p-2 rounded-xl shadow-[0_0_20px_rgba(108,92,231,0.2)] group-hover:scale-110 transition-transform">
